...
final productLike = <Product>[
  Product(
      name: "Áo xuông dài tay mặt cười in logo",
      description: "Trà sữa trân châu, thái xanh, truyền thống",
      price: 33000,
      urlImage: 'https://product.hstatic.net/1000285106/product/7f9e2159-a3be-43cf-98ae-56810bd8fbe7_1937ce8d1033418ba3e1488d35a9ad43_master.jpg',
  ...
  Product(
      ...
      name: "Cá hồi phi lê 1kg",
      description: "Cá hồi mới đánh bắt, tươi ngon",
      price: 90000,
      imgShop: "assets/images/3.jpg",
      nameShop: "Baba Tea",
      rate: "3.9",
  ...
  Product(
      ...
      name: "Rau củ thập cẩm ngẫu nhiên túi 500g",
